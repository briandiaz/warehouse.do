<g:set var="entityName" value="${message(code: 'area_User.label', default: 'Area of User')}" />
<g:applyLayout name="main">
	...
	<content tag="content">
		...
		<div id="create-department" class="content scaffold-create" role="main">
			...
			<g:form class="form-horizontal" role="form" url="[resource:area_UserInstance, action:'save']" >
				<fieldset class="form">
